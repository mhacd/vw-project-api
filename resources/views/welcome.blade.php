    ...
    <script>
       ...
       methods: {
        async sendReport (){
            ...
            let res = await axios.post('https://vw.mhacd.com/api/report',body)
            console.log(res)
        },
        async sendChat (){
            let body = {
            ...
            let res = await axios.post('https://vw.mhacd.com/api/chat', body)
            console.log(res)
        },
        report(){
            fetch('https://api.ipregistry.co/?key=g73shp4ykb6122t7')
                ...
                .then(function (payload) {
                    axios.post('https://vw.mhacd.com/api/report', {
                        ip:payload.ip,
